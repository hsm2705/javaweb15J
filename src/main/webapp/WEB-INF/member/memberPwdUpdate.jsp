...
<p><br/></p>
<div class="container">
  <form name="myform" method="post" action="${qwe}/MemberPwdUpdateOk.mem" class="was-validated">
  	...
  	<table class="table table-bordered">
  	  ...
  	  <tr>
  	    <td colspan="2" class="text-center">
  	      ...
  	      <input type="button" value="돌아가기" onclick="location.href='${qwe}/MemberMain.mem';" class="btn btn-secondary"/>
  	    </td>
  	  </tr>
  	</table>
  </form>
